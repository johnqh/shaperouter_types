...
/**
 * @description ShapeRouter user account, linked to Firebase Authentication.
...
/**
 * @description A ShapeRouter project that groups endpoints under a single API key.
...
export interface Project {
  ...
  is_active: boolean | null;
  /** Truncated prefix of the project API key for display (e.g., "shroute_live_ab..."). Full key is never returned in Project responses. */
 ...
 * are the normalized values ShapeRouter reports.
 */
export const FINISH_REASONS = [
  ...
  'tool_calls',
  /** The provider reported a reason ShapeRouter does not recognize. */
  'other',
] as const;
 ...
 * @example
 * ```typescript
 * import { successResponse, type Project } from '@sudobility/shaperouter_types';
 *
 ...
 * @example
 * ```typescript
 * import { errorResponse } from '@sudobility/shaperouter_types';
 *
